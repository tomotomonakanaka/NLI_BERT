...
class LSTM(nn.Module):
    def __init__(self, input_size, hidden_size, output_size=11, batch_first=True, num_layers=1, bidirectional=True, dropout=0.2):
    ...
    def forward(self, hiddens,target,length):
